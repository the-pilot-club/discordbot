...
execute(message) {
    ...
    const embed = new MessageEmbed()
        ...
        .addFields({name: '\u200b', value: 'To get a TPC callsign you just need to register one that has not yet been taken. You can do so with the button below and fill in the blanks!'})
